...
<body>
    ...
    <div class="container">
        ...
        <div class="row col col-md-12">
            ...
            <!-- form submit button -->
            <div class="row col-md-12" id="edit">
                <div id="edit_button" class="col-md-4 form-group">
                    <button class="btn btn-primary font-weight-bold" onclick="edit();">EDIT</button>
                </div>
                <div id="password_button" class="col-md-4 form-group">
            ...
            <div class="row col col-md-12 m-auto" id="update_cancel" style="display: none;">
                <div id="cancel_button" class="col col-md-4 form-group">
                    <button class="btn btn-danger font-weight-bold" onclick="edit(true);">CANCEL</button>
                </div>
                <div id="update_button" class="col col-md-4 form-group">
