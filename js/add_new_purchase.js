    ...
    function getAmount(row_number) {
        ...
        var rawTotal = document.getElementById("amount_" + row_number).value = qty * rate;
        ...
        for(var i = 1; i < row_count; i++) {
            var comp = medicine_info[i].children[0].children[7].children[0].value;
            amount = Number.parseFloat(comp);
            total += amount;
        }
