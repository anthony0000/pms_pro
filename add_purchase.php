    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="row col col-md-12">
                <div class="col col-md-4 font-weight-bold" style="color: green; cursor:pointer" onclick="document.getElementById('add_new_supplier_model').style.display = 'block';">
                    <i class="fa fa-plus"></i>&nbsp;Add New Supplier
                </div>
            </div>
            <!-- supplier details content end -->

            <div id="purchase_medicine_list_div" class="mt-4 mb-3">
