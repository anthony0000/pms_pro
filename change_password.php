    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="row col col-md-12">
                ...
                <div class="row col col-md-12 m-auto d-flex justify-content-center" id="change">
                    <div id="change_button" class="col col-md-4 form-group">
                        <button class="btn btn-warning font-weight-bold" onclick="changePassword();">Reset Password</button>
                    </div>
                    <div id="password_button" class="col col-md-4 form-group">
                        <a href="my_profile.php" class="btn btn-primary font-weight-bold">Profile</a>
                    </div>
                </div>
            </div>
