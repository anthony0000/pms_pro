    ...
    function searchInvoice($text, $column) {
        ...
        if($column == 'INVOICE_ID')
            $query = "SELECT * FROM invoices INNER JOIN customers ON invoices.CUSTOMER_ID = customers.ID WHERE invoices.$column LIKE '%$text%'";
    ...
    function printInvoice($invoice_number) {
        require "db_connection.php";
        if($con) {
            $query = "SELECT * FROM purchases INNER JOIN customers ON purchases.CUSTOMER_ID = customers.ID WHERE INVOICE_NUMBER = $invoice_number";
            $result = mysqli_query($con, $query);
        ...
        <div class="col-md-1"></div>
        <div class="col-md-4">
            <span class="h5"><b>Customer Details</b></span><br><br>
        ...
        ?>
        <div class="col-md-4">
            <span class="h5"><b>Shop Details</b></span><br><br>
            <span><?php echo $p_name; ?></span><br>
            <span><?php echo $p_address; ?></span><br>
            <span><?php echo $p_email; ?></span><br>
            <span>Mob No. <?php echo $p_contact_number; ?></span>
        </div>
        <div class="col-md-1"></div>
        </div>
        <div class="row text-center">
