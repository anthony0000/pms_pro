<?php
  ...
  function createMedicineInfoRow() {
      ...
      <div class="row col-md-12">
        ...
        <div class="col-md-4 mb-2">
          <input type="number" placeholder="Quantity" class="form-control" placeholder="0" id="quantity_<?php echo $row_number; ?>" name="quantity" onkeyup="getAmount(<?php echo $row_number; ?>);">
          <code class="text-danger small font-weight-bold float-right" id="quantity_error_<?php echo $row_number; ?>" style="display: none;"></code>
        </div>
        <div class="col-md-4 mb-2">
          <input type="number" placeholder="MRP" class="form-control" name="mrp">
          <code class="text-danger small font-weight-bold float-right" id="mrp_error_<?php echo $row_number; ?>" style="display: none;"></code>
        </div>
        <div class="col-md-4 mb-2">
          <input type="number" placeholder="Rate" class="form-control" id="rate_<?php echo $row_number; ?>" name="rate" onkeyup="getAmount(<?php echo $row_number; ?>);">
          <code class="text-danger small font-weight-bold float-right" id="rate_error_<?php echo $row_number; ?>" style="display: none;"></code>
        </div>
        <div class="col-md-4"><input type="text" class="form-control" id="amount_<?php echo $row_number; ?>"  placeholder="Amount" disabled></div>
        <div class="col-md-4">
          <button class="btn btn-primary btn-sm" onclick="addRow();">
            <i class="fa fa-plus"></i>
          </button>
          <button class="btn btn-danger btn-sm" onclick="removeRow('<?php echo $row_id ?>');">
