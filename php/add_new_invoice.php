    ...
    function createMedicineInfoRow() {
        ...
        <div class="row col col-md-12">
            ...
            <div class="col col-md-4 mt-3"><input placeholder="Batch ID" type="text" class="form-control" id="batch_id_<?php echo $row_number; ?>" disabled></div>
            <div class="col col-md-4 mt-3"><input placeholder="Available Qty." type="number" class="form-control" id="available_quantity_<?php echo $row_number; ?>" disabled></div>
            <div class="col col-md-4 mt-3"><input placeholder="Expiry date" type="text" class="form-control" id="expiry_date_<?php echo $row_number; ?>" disabled></div>
            <div class="col col-md-4 mt-3">
                <input type="number" placeholder="Qty." class="form-control" id="quantity_<?php echo $row_number; ?>" value="0" onkeyup="getTotal('<?php echo $row_number; ?>');" onblur="checkAvailableQuantity(this.value, '<?php echo $row_number; ?>');">
                <code class="text-danger small font-weight-bold float-right" id="quantity_error_<?php echo $row_number; ?>" style="display: none;"></code>
            </div>
            <div class="col col-md-4 mt-3"><input type="number" placeholder="MRP." class="form-control" id="mrp_<?php echo $row_number; ?>" onchange="getTotal('<?php echo $row_number; ?>');" disabled></div>
            <div class="col col-md-4 mt-3">
                <input type="number" placeholder="discount" class="form-control" id="discount_<?php echo $row_number; ?>" value="0" onkeyup="getTotal('<?php echo $row_number; ?>');">
                <code class="text-danger small font-weight-bold float-right" id="discount_error_<?php echo $row_number; ?>" style="display: none;"></code>
            </div>
            <div class="col col-md-4 mt-3"><input placeholder="Total" type="number" class="form-control" id="total_<?php echo $row_number; ?>" disabled></div>
            <div class="col col-md-4 mt-3">
